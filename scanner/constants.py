...
GSI_OUTPUT = OrderedDict(
    [
        ...
        ("Site:Hold", None),
        ("Site:Mod", None),
        ("SiteFrequency:Freq", None),
        ("SiteFrequency:IFX", None),
        ("SiteFrequency:SAS", None),
        ("SiteFrequency:SAD", None),
        ("DualWatch:PRI", None),
        ("DualWatch:CC", None),
        ("DualWatch:WX", None),
        ("Property:F", None),
        ...
        ("Property:Att", None),
        ("Property:Rec", None),
        ("Property:KeyLock", None),
        ("Property:P25Status", None),
        ("Property:Mute", None),
        ("Property:Backlight", None),
        ("Property:A_Led", None),
        ("Property:Dir", None),
        ("Property:Rssi", None),
...
WAV_METADATA = OrderedDict(
    [
        ...
        ("Channel:TGID", "ICMT"),
        ("ICMT", "Channel:TGID"),
        ("Channel:SetSlot", None),
        ("Channel:RecSlot", None),
        ("Channel:N_Tag", None),
        ("Channel:Hold", None),
        ("Channel:SvcType", None),
        ("Channel:P_Ch", None),
        ("Channel:LVL", None),
        ("UnitID:Name", None),
        ("UnitID:U_Id", "ITCH"),
